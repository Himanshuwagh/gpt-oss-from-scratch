...
with open("train_dataset.txt", "w") as f:
    for t, y in zip(train_dataset.input_ids, train_dataset.target_ids):
        f.write("input_ids: " + " ".join(map(str, t.tolist())) + "\n")
        f.write("target_ids: " + " ".join(map(str, y.tolist())) + "\n\n")

# Validation dataset
with open("val_dataset.txt", "w") as f:
    for t, y in zip(val_dataset.input_ids, val_dataset.target_ids):
        f.write("input_ids: " + " ".join(map(str, t.tolist())) + "\n")
        f.write("target_ids: " + " ".join(map(str, y.tolist())) + "\n\n")
